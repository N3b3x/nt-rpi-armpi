...
# 5.Basic Motion Lesson/Lesson 3 Move Up and Down
...
print('''
**********************************************************
****************Function: Move Up and Down in Inverse Kinematics********************
**********************************************************
----------------------------------------------------------
...
if __name__ == "__main__":
    ...
    '''
    AK.setPitchRangeMoving((0, 6, 22), 0,-90, 90, 1500) # set the initial position of the robotic arm to (x:0, y:6, z:18) and the runtime to 1500ms
    time.sleep(1.5) # delay for 1.5s
    
    for i in range(2): # 'for' runs in loop for 2 times
        AK.setPitchRangeMoving((0, 6, 22), 0,-90, 90, 1000) # set the robotic arm to move upwards to (x:0, y:6, z:22) and the runtime to 1000ms
        time.sleep(1.2) # delay for 1.2s
        
        AK.setPitchRangeMoving((0, 6, 18), 0,-90, 90, 1000) # set the robotic arm to move downwards to the initial position and the runtime to 1000ms
        time.sleep(1.2) # delay for 1.2s
